...
function fluentFormHandleScheduledEmailReport()
{
    ...
    \FluentForm\App\Services\Scheduler\Scheduler::maybeRemoveOldScheuledActionLogs();
}
...
function fluentformMaybeRemoveOldScheuledActionLogs($group_slug = 'fluentform', $days_old = 7)
{
    global $wpdb;
