...
class Builder
{
     ...
     * @param  \FluentForm\Framework\Database\Query\Grammar|null  $grammar
     * @param  \FluentForm\Framework\Database\Query\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|string|array|\FluentForm\Framework\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \FluentForm\Framework\Contracts\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  \FluentForm\Framework\Contracts\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     * @return $this
     */
    public function whereAny($columns,
        $operator = null,
        $value = null,
        $boolean = 'and'
    ) {
     ...
     *
     * @param  array  $columns
     * @param  \Closure|\FluentForm\Framework\Database\Query\Builder|\FluentForm\Framework\Database\Eloquent\Builder<*>|string  $query
     * @return int
     */
