 ...
 * @template TResult
 *
 * @extends \FluentForm\Framework\Database\Orm\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
     ...
     *
     * @param  \FluentForm\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentForm\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return void
     */
     ...
     *
     * @param  \FluentForm\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     * @return TRelatedModel
     *
     * @throws \FluentForm\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentForm\Framework\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \FluentForm\Framework\Database\Orm\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     *
     * @param  \FluentForm\Framework\Contracts\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentForm\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\FluentForm\Framework\Contracts\Support\ArrayableInterface<array-key, mixed>|array<mixed>) ? \FluentForm\Framework\Database\Orm\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \FluentForm\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return (
     *     $id is (\FluentForm\Framework\Contracts\Support\ArrayableInterface<array-key, mixed>|array<mixed>)
     *     ? \FluentForm\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     ...
     * @return \FluentForm\Framework\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentForm\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @param  \FluentForm\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentForm\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
