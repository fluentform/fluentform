...
use FluentForm\Framework\Database\Orm\Casts\Attribute;
use FluentForm\Framework\Database\Orm\Castable;
use FluentForm\Framework\Database\Orm\Casts\AsCollection;
use FluentForm\Framework\Database\Orm\Casts\AsArrayObject;
use FluentForm\Framework\Database\Orm\Relations\Relation;
use FluentForm\Framework\Database\Orm\InvalidCastException;
use FluentForm\Framework\Database\Orm\JsonEncodingException;
use FluentForm\Framework\Database\LazyLoadingViolationException;
use FluentForm\Framework\Database\Orm\CastsInboundAttributes;
use FluentForm\Framework\Support\Collection as BaseCollection;
use FluentForm\Framework\Database\Orm\MissingAttributeException;
...
trait HasAttributes
{
     ...
     *
     * @var \FluentForm\Framework\Encryption\Encrypter
     */
     ...
     * @return null
     *
     * @throws \FluentForm\Framework\Database\Orm\MissingAttributeException
     */
     ...
     *
     * @param  \FluentForm\Framework\Encryption\Encrypter  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \FluentForm\Framework\Database\Orm\InvalidCastException
     */
