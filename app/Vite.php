...
class Vite
{
    ...
    {
        return self::getInstance()->enqueue_script($handle, $src, $dependency, $version, $inFooter);
    }
    ...
    {
        self::getInstance()->enqueue_style($handle, $src, $dependency, $version, $media);
    }
    ...
    {
        return self::getInstance()->enqueue_static_script($handle, $src, $dependency, $version, $inFooter);
    }
    ...
    {
        self::getInstance()->enqueue_static_style($handle, $src, $dependency, $version, $media);
    }
    ...
    {
        return self::getInstance()->usingDevMode();
    }

    public static function getEnqueuePath($path = ''): string
    {
        $vite = self::getInstance();
    ...
    {
        return esc_url(self::getInstance()->get_asset_url($path));
    }
