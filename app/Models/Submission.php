...
class Submission extends Model
{
    ...
    public function remove($entryIds)
    {
        $this->whereIn('id', $entryIds)->delete();

        $this->submissionMeta()->whereIn('response_id', $entryIds)->delete();
        ...
        $this->entryDetails()->whereIn('submission_id', $entryIds)->delete();
