...
class Checkable extends BaseComponent
{
    ...
    public function compile($data, $form)
    {
        ...
        $elMarkup .= '<legend  style="  position: absolute;width: 1px;height: 1px;padding: 0;margin: 0;overflow: hidden;clip: rect(0, 0, 0, 0);border: 0;"  role="heading" id="legend_' . $legendId . '" class="ff-sreader-only">' . esc_html($data['settings']['label']) . '</legend>';
