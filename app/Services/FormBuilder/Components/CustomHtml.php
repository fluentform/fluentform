...
class CustomHtml extends BaseComponent
{
    ...
    public function compile($data, $form)
    {
        ...
        $html = "<div tabindex='0' class='" . esc_attr($cls) . "' {$atts}>" . fluentform_sanitize_html($data['settings']['html_codes']) . '</div>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- $atts is escaped before being passed in.
