...
class ReportService
{
    ...
    public function form($attr = [])
    {
        ...
        $statuses = Arr::get($attr, 'statuses',
            ['read', 'unread', 'unapproved', 'approved', 'declined', 'unconfirmed', 'confirmed']);
        ...
        try {
            switch ($groupBy) {
                case 'forms':
                    ...
                    break;
                case 'payment_method':
                    $data = ReportHelper::getNetRevenueByPaymentMethod($startDate, $endDate, $formId, $perPage,
                        $currentPage);
                    break;
                case 'payment_type':
                    $data = ReportHelper::getNetRevenueByPaymentType($startDate, $endDate, $formId, $perPage,
                        $currentPage);
                    break;
                default:
