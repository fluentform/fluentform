...
class TranslationString
{
    public static function getAdminI18n()
    {
        $i18n = array(
            ...
            'Create Using Gemini' => __('Create Using Gemini', 'fluentform'),
            ...
            'Use AI to create the initial structure. The response uses Gemini, so please note that there might be some inaccuracy in the output.' => __('Use AI to create the initial structure. The response uses Gemini, so please note that there might be some inaccuracy in the output.', 'fluentform'),
