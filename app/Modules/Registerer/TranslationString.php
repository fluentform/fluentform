...
class TranslationString
{
    ...
    public static function getEditorI18n()
    {
        $i18n = array(
            ...
            'Select to match whether all rules are required, any rule is sufficient, or use group logic. If the conditions match, the field will be shown. For groups, if any group\'s conditions are fully met, the field will be shown.' => __('Select to match whether all rules are required, any rule is sufficient, or use group logic. If the conditions match, the field will be shown. For groups, if any group\'s conditions are fully met, the field will be shown.', 'fluentform'),
