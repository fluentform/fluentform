...
class TranslationString
{
    public static function getAdminI18n()
    {
        $i18n = array(
            ...
            'Create a form with AI using ChatGPT' => __('Create a form with AI using ChatGPT', 'fluentform'),
    ...
    public static function getSettingsI18n()
    {
        $i18n = array(
            ...
            'no' => __('no', 'fluentform'),
            'You are using the free version of Fluent Forms.' => __('You are using the free version of Fluent Forms.', 'fluentform'),
            'Enable admin approval email notifications to inform the admin of pending submissions from' => __('Enable admin approval email notifications to inform the admin of pending submissions from', 'fluentform'),
            'Global Settings' => __('Global Settings', 'fluentform'),
            'After approve form data & email notification will be processed.You can configure an email for users declined submissions.' => __('After approve form data & email notification will be processed.You can configure an email for users declined submissions.', 'fluentform'),
    ...
    public static function getGlobalSettingsI18n()
    {
        $i18n = array(
            ...
            'To unlock more features consider' => __('To unlock more features consider', 'fluentform'),
            'upgrading to PRO' => __('upgrading to PRO', 'fluentform'),
            ...
            'These messages will be used as default messages of all form. These messages will be ignored when field error message set as custom.' => __('These messages will be used as default messages of all form. These messages will be ignored when field error message set as custom.', 'fluentform'),
            'Version 2 (Visible reCAPTCHA)' => __('Version 2 (Visible reCAPTCHA)', 'fluentform'),
            'Version 3 (Invisible reCAPTCHA)' => __('Version 3 (Invisible reCAPTCHA)', 'fluentform'),
            ...
            'Always (Default)' => __('Execute', 'fluentform'),
            ...
            'Execute' => __('Always (Default)', 'fluentform'),
            ...
            'Global Message For ' => __('Global Message For ', 'fluentform'),
