...
class TranslationString
{
    ...
    public static function getGlobalSettingsI18n()
    {
        $i18n = array(
            ...
            'Advanced Inventory' => __('Advanced Inventory', 'fluentform'),
            'Advanced Inventories can be used across different forms. You can manage tickets, items, event registration etc.' => __('Advanced Inventories can be used across different forms. You can manage tickets, items, event registration etc.', 'fluentform'),
