...
class TranslationString
{
    ...
    public static function getSettingsI18n()
    {
        $i18n = array(
            ...
            'Automated Reminder Emails' => __('Automated Reminder Emails', 'fluentform'),
            'Enable Automated Reminder Emails to inform the users of pending submissions from after a time period using cron jobs.' => __('Enable Automated Reminder Emails to inform the users of pending submissions from after a time period using cron jobs.', 'fluentform'),
            'Enable Automated Reminder Emails for Partial Entries' => __('Enable Automated Reminder Emails for Partial Entries', 'fluentform'),
            'Reminder Intervals' => __('Reminder Intervals', 'fluentform'),
            'Select when to send reminder emails after the last update. Each interval will send one reminder. Add multiple intervals to send multiple reminders. Example: [60, 360, 1440] will send 3 reminders at 1 hour, 6 hours, and 1 day. You can add custom intervals by typing in minutes minimum 5 minutes and maximum 1 year which is 525600 minutes.' => __('Select when to send reminder emails after the last update. Each interval will send one reminder. Add multiple intervals to send multiple reminders. Example: [60, 360, 1440] will send 3 reminders at 1 hour, 6 hours, and 1 day. You can add custom intervals by typing in minutes minimum 5 minutes and maximum 1 year which is 525600 minutes.', 'fluentform'),
            'Select or enter custom interval in minutes' => __('Select or enter custom interval in minutes', 'fluentform'),
            '5 minutes' => __('5 minutes', 'fluentform'),
            '10 minutes' => __('10 minutes', 'fluentform'),
            '30 minutes' => __('30 minutes', 'fluentform'),
            '1 hour (60 min)' => __('1 hour (60 min)', 'fluentform'),
            '6 hours (360 min)' => __('6 hours (360 min)', 'fluentform'),
            '12 hours (720 min)' => __('12 hours (720 min)', 'fluentform'),
            '1 day (1440 min)' => __('1 day (1440 min)', 'fluentform'),
            '3 days (4320 min)' => __('3 days (4320 min)', 'fluentform'),
            '1 week (10080 min)' => __('1 week (10080 min)', 'fluentform'),
            '1 month (43200 min)' => __('1 month (43200 min)', 'fluentform'),
            'Send Reminder To' => __('Send Reminder To', 'fluentform'),
            'Select which email field to use for sending reminders. Resume Link Email is the email used when user sends resume link to themselves.' => __('Select which email field to use for sending reminders. Resume Link Email is the email used when user sends resume link to themselves.', 'fluentform'),
            'Resume Link Email' => __('Resume Link Email', 'fluentform'),
            'Email Subject' => __('Email Subject', 'fluentform'),
            'Available shortcodes: {form_name}, {resume_link}, {entry_id}' => __('Available shortcodes: {form_name}, {resume_link}, {entry_id}', 'fluentform'),
            'Complete your submission for {form_name}' => __('Complete your submission for {form_name}', 'fluentform'),
            'Please enter valid numbers only' => __('Please enter valid numbers only', 'fluentform'),
            'Intervals must be at least 5 minutes (cron runs every 5 minutes)' => __('Intervals must be at least 5 minutes (cron runs every 5 minutes)', 'fluentform'),
            'Intervals cannot exceed 525600 minutes (1 year)' => __('Intervals cannot exceed 525600 minutes (1 year)', 'fluentform'),
        );
