...
class TranslationString
{
    ...
    public static function getPaymentsI18n()
    {
        $i18n = array(
            ...
            'This is where user can view their single payments.' => __('This is where user can view their single payments.', 'fluentform'),
            'Add shortcode %s[fluentform_payments]%s in the selected page. This shortcode will show payments and subscriptions to the logged-in user' => __('Add shortcode %s[fluentform_payments]%s in the selected page. This shortcode will show payments and subscriptions to the logged-in user', 'fluentform'),
            'Add shortcode %s[fluentform_payments]%s in the selected page. This shortcode will show payments to the logged-in user' => __('Add shortcode %s[fluentform_payments]%s in the selected page. This shortcode will show payments to the logged-in user', 'fluentform'),
            ...
            'This is where user can view their payment receipt.' => __('This is where user can view their payment receipt.', 'fluentform'),
            ...
            'Payment Pages Management' => __('Payment Pages Management', 'fluentform'),
