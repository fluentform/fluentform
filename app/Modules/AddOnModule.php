...
class AddOnModule
{
    ...
    public function showFluentAddOns()
    {
        ...
        $addOns['slack'] = [
            ...
            'logo'        => Enqueue::getStaticFilePath('img/integrations/slack.png'),
    ...
    public function getPremiumAddOns()
    {
        ...
        return [
            'paypal' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/paypal.png'),
                'enabled'      => 'no',
            ...
            'stripe' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/stripe.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'payment',
            ],
            'UserRegistration' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/user_registration.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'wp_core',
            ],
            'PostFeeds' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/post-creation.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'wp_core',
            ],
            'sharePages' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/landing_pages.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'wp_core',
            ],
            'webhook' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/webhook.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'zapier' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/zapier.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'trello' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/trello.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'google_sheet' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/google-sheets.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'activecampaign' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/activecampaign.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'campaign_monitor' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/campaignmonitor.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'constatantcontact' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/constantcontact.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'convertkit' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/convertkit.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'getresponse' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/getresponse.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'hubspot' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/hubspot.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'icontact' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/icontact.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'platformly' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/platformly.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'moosend' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/moosend_logo.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'sendfox' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/sendfox.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'mailerlite' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/mailerlite.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'sms_notifications' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/twilio.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'get_gist' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/getgist.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'sendinblue' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/brevo.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'drip' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/drip.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'discord' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/discord.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'telegram' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/telegram.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'affiliateWp' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/affiliatewp.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'clicksend_sms_notification' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/clicksend.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'zohocrm' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/zohocrm.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'cleverreach' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/clever_reach.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'salesflare' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/salesflare.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'automizy' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/automizy.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'salesforce' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/salesforce.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'airtable' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/airtable.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'mailjet' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/mailjet.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
            'quiz_addon' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/quiz-icon.svg'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'wp_core',
            ],
            'notion' => [
                ...
                'logo'         => Enqueue::getStaticFilePath('img/integrations/notion.png'),
                'enabled'      => 'no',
                'purchase_url' => $purchaseUrl,
                'category'     => 'crm',
            ],
    ...
    public function showSuggestedPlugins()
    {
        ...
        wp_localize_script('fluentform-modules', 'fluent_suggested_plugins', [
            ...
            'assets_url' => Enqueue::getStaticFilePath('img/suggested-plugins/'),
        ]);
