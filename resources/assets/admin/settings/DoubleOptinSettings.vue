                ...
                <card>
                    ...
                    <card-body>
                        <el-form-item class="ff-form-item">
                            <el-checkbox true-value="yes" false-value="no" v-model="settings.enabled">
                        ...
                        <template v-if="settings.enabled === 'yes'">
                            ...
                            <el-form-item class="ff-form-item">
                                ...
                                <el-input v-if="settings.asPlainText === 'yes'" v-model="settings.email_body"
                                          type="textarea" :rows="12"></el-input>
                                <wp-editor v-else :height="250"
                                           v-model="settings.email_body"/>

                                <el-checkbox class="mt-3 mb-2" true-value="yes" false-value="no"
                                             v-model="settings.asPlainText">
                                    {{ $t('Send Email as RAW HTML Format') }}
                                </el-checkbox>

                                <p class="text-note">
                                    {{ $t('Use #confirmation_url# smartcode for double optin confirmation URL') }}</p>
                            ...
                            <el-form-item class="ff-form-item">
                                <el-checkbox true-value="yes" false-value="no" v-model="settings.auto_delete_status">
                                    {{
