            ...
            <el-row :gutter="6">
                <el-col :md="18">
                    ...
                    <p class="ff_block_text">
                        {{ $t("Global Inventories can be used across different forms. You can manage tickets, items, event registration etc.")
                        }}</p>
                </el-col>
                        ...
                        <el-table class="ff_table_s2" :data="pagedTableData">
                            ...
                            <el-table-column type="expand">
                                <template #default="scope">
                                    <el-table v-if="scope.row.details" :data="formatTableData(scope.row.details)" border
                                              style="width: 100%">
