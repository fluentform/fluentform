<template>
    <div>
        ...
        <div v-if="settings.hide_on_valid && integration.status" class="integration_success_state">
            ...
            <el-button @click="disconnect(settings.discard_settings.data)" type="danger" size="small">{{settings.discard_settings.button_text}}</el-button>
            <el-button v-if="settings.discard_settings.show_verify" v-loading="saving" @click="save()" type="success" size="small">Verify Connection Again</el-button>
