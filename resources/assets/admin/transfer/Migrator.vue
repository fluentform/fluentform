                    ...
                    <el-skeleton :loading="loading" animated :rows="8">
                        <el-tabs v-if="migratorData.length" v-model="currentFormType" @tab-click="getForms">
                            ...
                            <div v-if="migratedForms.length">
                                <h5 class="mb-2 mt-5" style="border-top: 1px solid #ececec; padding-top: 20px;">
                                    {{ $t("Imported Forms") }}</h5>
                        ...
                        <p v-else>
                            <b>{{ $t("Migration tools only works if you have any other contact form plugin already installed along with Fluent Forms.")
                                }}</b>
                            <a href="https://wpmanageninja.com/docs/fluent-form/import-export/fluent-forms-migrator-caldera-forms-ninja-forms-gravity-forms/"
