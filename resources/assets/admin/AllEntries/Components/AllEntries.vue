    ...
    <div class="ff_entries_wrapper">
        <section-head class="ff_section_head_between mb-0">
            <section-head-content>
                <h1 class="ff_section_title">
                    {{ selectedFormName ? $t("Entries from " + selectedFormName) : $t("Entries from All Forms") }}</h1>
            </section-head-content>
            <section-head-content>
                <btn-group as="div">
        ...
        <div v-if="chart_status === 'yes'" ref="entry_chart" class="entry_chart mt-4 mb-4">
            <entry-chart :form_id="selectedFormId" :date_range="filter_date_range"
                         :entry_status="entry_status"></entry-chart>
        </div>
                        ...
                        <el-row :gutter="18">
                            ...
                            <el-col :xs="24" :span="13">
                                <div class="ff_radio_group_wrap">
                                    <el-radio-group class="ff_radio_group_s2" @change="fetchEntries('reset')"
                    ...
                    <el-skeleton :loading="loading" animated :rows="10">
                        <el-table :data="entries">
                            <el-table-column width="200" prop="id" sortable :label="$t('Submission ID')">
                                <template #default="scope">
                                    <a :href="scope.row.entry_url">
                                        ...
                                        <span class="ff_payment_badge"
                                              v-if="scope.row.total_paid">{{ formatMoney(scope.row) }}</span>
                                    </a>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column width="150" :label="$t('Action')">
                                <template #default="scope">
                                    <a :href="scope.row.entry_url"
                                       class="el-button el-button--primary el-button--soft el-button--small">
