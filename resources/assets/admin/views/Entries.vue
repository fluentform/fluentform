<template>
    <div class="ff_entries_wrap">
            ...
            <section-head-content>
                <btn-group>
                    <btn-group-item as="div">
                        <el-button @click="gotoVisualReport()" type="primary" size="large">
                            <template #icon>
                        ...
                        <el-dropdown @command="selectFieldsToExport" trigger="click">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu>
                                    ...
                                    <el-dropdown-item command="xlsx">{{ $t("Export as") }} Excel (xlsv)
                                    </el-dropdown-item>
                    ...
                    <btn-group-item as="div">
                        ...
                        >
                            ...
                            <template #dropdown>
                                <el-dropdown-menu style="max-height:300px; overflow-y:scroll;">
                                    <el-dropdown-item
                                        v-for="form in forms"
        ...
        <section-head class="ff_form_editor_entries_actions ff_section_head_between items-center" size="sm">
            ...
            <section-head-content>
                <btn-group class="ff_entries_report_wrap" as="div">
                    ...
                    <btn-group-item as="div">
                        <el-dropdown v-if="!entrySelections.length" trigger="click" class="current_form_name_column"
                                     :hide-on-click="false">
                            <el-button size="large">
                                {{ $t("Columns") }}
                                <template #icon>
                            ...
                            <template #dropdown>
                                <el-dropdown-menu class="ff-dropdown-menu"
                                    ...
                                    <el-dropdown-item v-for="(column, column_name) in columns" :key="column_name">
                                        <el-checkbox-group v-model="visibleColumns" @change="handleColumnChange">
                                            <el-checkbox :value="column_name" :label="column"></el-checkbox>
                                        </el-checkbox-group>
                                    </el-dropdown-item>
                    ...
                    <btn-group-item as="div">
                        <div class="ff_advanced_filter_wrap">
                            <el-button @click="basicFilter = !basicFilter"
                                       :class="this.filter_date_range && 'ff_filter_selected'" size="large">
                                <span>{{ $t("Filter") }}</span>
                                <template #icon>
                    ...
                    <btn-group-item as="div">
                        <el-button @click="getData" v-loading="loading && visibleColumns" size="large">
                            <template #icon>
        ...
        <el-dialog v-model="visibleColReorderModal">
            <template #header>
        ...
        <div style="min-height: 300px;" class="entries_table">
                                ...
                                <btn-group size="sm">
                                    <btn-group-item>
                                        <router-link :to="{
                                            ...
                                            <el-button class="el-button--icon" type="primary" size="small">
                                                <template #icon>
            ...
            <el-row class="mt-4 items-center">
                <el-col :span="12">
                    <div class="bulkactions">
                        ...
                        <el-checkbox class="compact_input" v-model="isCompact" @change="handleCompactView">
                            {{ $t("Compact View") }}
                        </el-checkbox>
                    </div>
                </el-col>
            ...
            <div :class="{'ff_backdrop': input_selection_visibility}">
                <el-dialog
                    ...
                    v-model="input_selection_visibility"
                ...
                >
                    ...
                    <el-checkbox v-if="has_pro" class="mt-5" :indeterminate="isIndeterminateFieldsSelection"
                                 v-model="checkAllFields" @change="handleCheckAllFieldsChange">{{ $t("Check all") }}
                    </el-checkbox>

                    <div class="ff_card_wrap mt-5 mb-4">

                        <el-checkbox-group class="ff_2_col_items mb15" v-model="fieldsToExport"
                                           @change="handleCheckedFieldsChange">
                            <div>
                                <p><b>{{ $t("Form Inputs") }}</b></p>
                                <div class="separator mb-4"></div>
                                <el-checkbox :disabled="!has_pro" v-for="(label,name) in input_labels" :value="name"
                                             :key="name">{{ label }}
                                </el-checkbox>
                            </div>
                        </el-checkbox-group>

                        <el-checkbox-group class="ff_2_col_items " v-model="shortcodesToExport"
                                           @change="handleCheckedFieldsChange">
                            <div>
                                <p><b>{{ $t("Submission Info") }}</b></p>
                                <div class="separator mb-4"></div>
                                <el-checkbox :disabled="!has_pro" v-for="(label,name) in editor_shortcodes"
                                             :value="name" :key="name">{{ label }}
                                </el-checkbox>
                            </div>
                        </el-checkbox-group>
                    ...
                    <template #footer class="dialog-footer">
                        ...
                        <el-button type="primary" @click="exportEntries()">
                            <template #icon>
...
import ColumnDragAndDrop from "./ColumnDragAndDrop.vue";
...
import AdvancedSearch from "@/admin/views/_AdvancedSearch.vue";
