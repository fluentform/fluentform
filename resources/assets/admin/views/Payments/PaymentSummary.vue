                    ...
                    <table class="ff-table ff-payment-table">
                        ...
                        <template v-if="order_data.discount_items && order_data.discount_items.length">
                            <tr>
                                ...
                                <th><span
                                    v-html="formatMoney(order_data.order_items_subtotal, submission.currency)"></span>
                                </th>
                            </tr>
                        ...
                        <tr>
                            ...
                            <th><span v-html="formatMoney(order_data.order_items_total, submission.currency)"></span>
                            </th>
                        </tr>
                        </tfoot>
                    </table>
                    ...
                    <ul class="ff_list_items mb-3">
                        ...
                        <li>
                            ...
                            <div class="ff_list_value">
                                <span class="ff_badge ff_badge_primary"
                        ...
                        <li>
                            ...
                            <div class="ff_list_value"
                                 v-html="formatMoney(transaction.payment_total, transaction.currency)"></div>
                        </li>
                        <li v-show="transaction.status">
                            <div class="ff_list_header">{{ $t("Payment Status") }}</div>
                            <div class="ff_list_value">
                                <span class="ff_badge is-solid"
                                      :class="'ff_badge_'+transaction.status">{{ payment_statuses[transaction.status] || transaction.status
                                    }}</span>
                            </div>
                        </li>
                        <li>
                    ...
                    <div class="transaction_item_small">
                        <div class="transaction_item_heading">
                            ...
                            <div class="transaction_heading_action">
                                <a class="el-button el-button--danger el-button--mini" v-if="transaction.action_url"
                                   target="_blank"
                                   :href="transaction.action_url">
                                    {{ $t("View") }}
                                </a>
        ...
        >
            ...
            <el-form class="mt-4" label-position="top" v-if="editingTransaction" :data="editingTransaction">
                ...
                <el-form-item class="ff-form-item" :label="$t('Billing Email')">
                    <el-input type="email" :placeholder="$t('Billing Email')"
                              v-model="editingTransaction.payer_email" />
                </el-form-item>
                <el-form-item class="ff-form-item" :label="$t('Billing Address')">
                    <el-input type="textarea" :placeholder="$t('Billing Address')"
                              v-model="editingTransaction.billing_address" />
                </el-form-item>
                <el-form-item class="ff-form-item" :label="$t('Shipping Address')">
                    <el-input type="textarea" :placeholder="$t('Shipping Address')"
                              v-model="editingTransaction.shipping_address" />
                </el-form-item>
                ...
                <el-form-item class="ff-form-item" v-if="editingTransaction.payment_method == 'test'"
                              :label="$t('Note')">
                    <el-input type="textarea" :placeholder="$t('Reference ID')"
                              v-model="editingTransaction.payment_note" />
                </el-form-item>
                <el-form-item class="ff-form-item" :label="$t('Status')">
                    ...
                    <p class="text-note mt-2"
                       v-if="(editingTransaction.status == 'refunded' || editingTransaction.status == 'partial-refunded') && original_editing_status != editingTransaction.status">
                ...
                <el-form-item class="ff-form-item" :label="$t('Run Actions')"
                              v-if="editingTransaction.status === 'paid'">
            ...
            <template #footer class="dialog-footer">
                <el-button @click="transactionModal = false" type="info"
                           class="el-button--soft">{{ $t("Cancel") }}
                </el-button>
