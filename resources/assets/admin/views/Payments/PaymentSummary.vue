                ...
                <div v-for="(transaction, index) in order_data.transactions" class="wpf_entry_transaction" :key="index">
                    ...
                    <ul class="ff_list_items mb-3">
                        ...
                        <li v-show="transaction.status">
                            ...
                            <div class="ff_list_value">
                                <span class="ff_badge is-solid" :class="'ff_badge_'+transaction.status">{{
                                        payment_statuses[transaction.status] || transaction.status
                                    }}</span>
                            </div>
                        </li>
                        <li>
                        ...
                        <div class="transaction_item_body">
                            <div class="transaction_item_line">
                                <span class="ff_badge is-solid small ff_badge_paid"
                                      v-html="formatMoney(transaction.payment_total, transaction.currency)"></span>
                                {{ $t('has been refunded via') }}
                            ...
                            <p v-if="transaction.payment_note && typeof transaction.payment_note == 'string'">
                                {{ $t('Note') }}: {{ transaction.payment_note }}</p>
                        </div>
                    </div>
                </div>
            </card-body>
        ...
        >
            ...
            <template #footer class="dialog-footer">
                <el-button @click="transactionModal = false" type="info"
                           class="el-button--soft">{{ $t('Cancel') }}</el-button>
