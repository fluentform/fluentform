    ...
    <div class="entry-repeat-field">
        <template v-if="hasRepeaterValue">
            <table class="editor_table">
                <thead>
                <tr>
                    <th v-for="(fieldItem, fieldKey) in field.raw.fields" :key="fieldKey">
                        {{ fieldItem.settings.label }}
                    </th>
                    <th>{{ $t("Action") }}</th>
                </tr>
                </thead>
                ...
                <tr v-for="(rowValue, rowIndex) in repeaters" :key="rowIndex">
                    <td v-for="(fieldItem, fieldIndex) in field.raw.fields" :key="fieldIndex">
                        <el-select
                            ...
                            v-model="model[rowIndex][fieldIndex]" size="small"
                        >
                            <el-option
                    ...
                    <td>
                        <div class="action-buttons-group">
                            <el-button @click="addRow(rowIndex)" size="small">
                                <template #icon>
                                    <i class="el-icon-plus"></i>
                                </template>
                            </el-button>
                            <el-button @click="removeRow(rowIndex)" size="small">
                                <template #icon>
        ...
        <el-button v-else @click="initNewRow()" type="success" size="small">
            <template #icon>
                <i class="el-icon-plus"></i>
            </template>
            {{ $t("Add Item") }}
