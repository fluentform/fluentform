                ...
                <div v-loading="loading" :element-loading-text="$t('Loading Feeds...')" class="ff_notification_feeds">
                    ...
                    <el-table border stripe v-loading="sending" :data="feeds">
                        ...
                        <el-table-column
                            ...
                            <template #default="scope">
                                <el-tag
                                    :type="`${scope.row.action_status === 'failed' ? 'danger' : scope.row.action_status === 'success' ? 'success' : 'info'}`"
                        ...
                        <el-table-column
                            :label="$t('Action')">
                            <template #default="scope">
                                <el-button @click="replayFeed(scope.row.id, scope.row.action_id)" type="info"
                                           size="small">
                                    {{ $t("Replay") }}
                                </el-button>
