                                ...
                                <el-form-item class="ff-form-item">
                                    <template #label>
                                        ...
                                        <el-tooltip class="item" placement="bottom-start"
                                            ...
                                            <template #content>
                                                <p> {{
                                                        $t('Please select the customer name field from your form inputs.It\'s optional ield but recommended.If user is logged in then this data will be picked from logged in user.')
                                                    }} </p>
                                            </template>
                                            <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                        </el-tooltip>
                                ...
                                <el-form-item class="ff-form-item">
                                    <template #label>
                                        ...
                                        <el-tooltip class="item" placement="bottom-start"
                                            ...
                                            <template #content>
                                                <p>{{
                                                        ('Please select the customer address field from your form\'s address inputs. It\'s required for payments in India.')
                                                    }} </p>
                                            </template>
                                            <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                        </el-tooltip>
                            ...
                            <div class="ff_payment_mode_wrap mb-4" v-if="settings.stripe_account_type == 'custom'">
                                ...
                                <p>
                                    ...
                                    <a target="_blank" rel="noopener"
                                       href="https://dashboard.stripe.com/apikeys">{{ $t('Stripe Dashboard') }}</a>
                                </p>
                            </div>
                            ...
                            <el-form-item class="ff-form-item" label="">
                                <template #label>
                                    ...
                                    <el-tooltip class="item" placement="bottom-start" popper-class="ff_tooltip_wrap">
                                        <template #content>
                                            <p>
                                                {{ $t('You can select which PayPal account email will be used for this form.Select "Custom PayPal ID" for a different PayPal account than global.') }} </p>
                                        </template>
                                        <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                    </el-tooltip>
                                </template>
