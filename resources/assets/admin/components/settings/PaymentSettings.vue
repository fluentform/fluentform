                ...
                <div v-loading="loading" class="ff-payment-settings-wrapper">
                    <el-form v-if="settings" label-position="top">
                        <el-form-item class="ff-form-item" :label="$t('Currency')">
                            <el-select class="ff_input_width" filterable v-model="settings.currency"
                        ...
                        <el-form-item class="ff-form-item" :label="$t('Transaction Type')">
                            <el-radio-group v-model="settings.transaction_type">
                                <el-radio value="product">{{ $t("Products / Services") }}</el-radio>
                                <el-radio value="donation">{{ $t("Donations") }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
                                ...
                                <el-form-item class="ff-form-item">
                                    <template #label>
                                        ...
                                        <el-tooltip class="item" placement="bottom-start"
                                            ...
                                            <template #content>
                                                <p> {{
                                                        $t("Please select the customer email field from your form's email inputs. It's optional field but recommended.")
                                                    }} </p>
                                            </template>
                                            <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                        </el-tooltip>
                                    </template>
                                    <el-select class="w-100" autoComplete="new_password"
                                               v-model="settings.receipt_email" clearable filterable
                                ...
                                <el-form-item class="ff-form-item">
                                    <template #label>
                                        ...
                                        <el-tooltip class="item" placement="bottom-start"
                                            ...
                                            <template #content>
                                                <p>
                                                    {{ $t("Please select the customer name field from your form inputs. It's an optional but recommended field. If the user is logged in then this data will be picked from logged in user.")
                                                    }} </p>
                                            </template>
                                            <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                        </el-tooltip>
                                ...
                                <el-form-item class="ff-form-item">
                                    <template #label>
                                        ...
                                        <el-tooltip class="item" placement="bottom-start"
                                            ...
                                            <template #content>
                                                <p>
                                                    {{ $t("Please select the customer address field from your form's address inputs. It's required for payments in India.")
                                                    }} </p>
                                            </template>
                                            <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                        </el-tooltip>
                                    </template>
                                    <el-select class="w-100" v-model="settings.customer_address" clearable filterable
                                               :placeholder="$t('Select an address field')">
                                        <el-option
                        ...
                        <div class="ff_card_block" v-if="payment_methods.stripe">
                            ...
                            <el-form-item class="ff-form-item" :label="$t('Stripe Meta Data')">
                                <el-checkbox true-value="yes" false-value="no" v-model="settings.push_meta_to_stripe">{{
                            ...
                            <el-form-item class="ff-form-item" label="">
                                <template #label>
                                    ...
                                    <el-tooltip class="item" placement="bottom-start" popper-class="ff_tooltip_wrap">
                                        <template #content>
                                            <p>
                                                {{ $t("You can select which stripe account credential will be used for this form.Select \"Custom Stripe Credential\" for a different stripe account than global.")
                                                }} </p>
                                        </template>
                                        <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                    </el-tooltip>
                                ...
                                <el-radio-group v-model="settings.stripe_account_type">
                                    ...
                                    <el-radio value="custom">{{ $t("Custom Stripe Credentials") }}</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            ...
                            <div class="ff_payment_mode_wrap mb-4" v-if="settings.stripe_account_type == 'custom'">
                                <el-form-item class="ff-form-item" label="">
                                    ...
                                    <el-radio-group v-model="settings.stripe_custom_config.payment_mode">
                                        <el-radio value="live">{{ $t("Live Mode") }}</el-radio>
                                        <el-radio value="test">{{ $t("Test Mode") }}</el-radio>
                                    </el-radio-group>
                                </el-form-item>
                            ...
                            <el-form-item class="ff-form-item" :label="$t('Stripe Payment Receipt')">
                                <el-checkbox true-value="yes" false-value="no"
                                             v-model="settings.disable_stripe_payment_receipt">
                            ...
                            <el-form-item class="ff-form-item">
                                <template #label>
                                    ...
                                    <el-tooltip class="item" placement="bottom-start" popper-class="ff_tooltip_wrap">
                                        <template #content>
                                            <p>{{
                                                    $t("Provide the statement descriptor. If you keep it empty then your form name will be set. (Contains between 5 and 22 characters)")
                                                }} </p>
                                        </template>
                                        <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                    </el-tooltip>
                                </template>
                                <el-input :placeholder="$t('Statement Description')" type="text" maxlength="22"
                                          v-model="settings.stripe_descriptor" />
                            </el-form-item>
                        </div>
                        ...
                        <div class="ff_card_block mt-4" v-if="payment_methods.paypal">
                            ...
                            <el-form-item class="ff-form-item" label="">
                                <template #label>
                                    ...
                                    <el-tooltip class="item" placement="bottom-start" popper-class="ff_tooltip_wrap">
                                        <template #content>
                                            <p>
                                                {{ $t("You can select which PayPal account email will be used for this form.Select \"Custom PayPal ID\" for a different PayPal account than global.")
                                                }} </p>
                                        </template>
                                        <i class="ff-icon ff-icon-info-filled text-primary"></i>
                                    </el-tooltip>
                                ...
                                <el-radio-group v-model="settings.paypal_account_type">
                                    <el-radio value="global">{{ $t("As per global settings") }}</el-radio>
                                    <el-radio value="custom">{{ $t("Custom PayPal ID") }}</el-radio>
                                </el-radio-group>
                            </el-form-item>
                            <template v-if="settings.paypal_account_type == 'custom'">
                                ...
                                <el-form-item class="ff-form-item" label="PayPal Email">
                                    <el-input type="email" v-model="settings.custom_paypal_id"
                                              :placeholder="$t('Custom PayPal Email')" />
                                </el-form-item>
                            </template>
                        </div>
                        ...
                        <div class="ff_card_block mt-4" v-if="payment_methods.paddle">
                            ...
                            <el-form-item class="ff-form-item" label="">
                                ...
                                <el-radio-group v-model="settings.paddle_transaction_type">
                                    <el-radio value="non_catalog">{{ $t("Non-catalog") }}</el-radio>
                                    <el-radio value="catalog">{{ $t("Catalog Item") }}</el-radio>
                                    <el-radio value="non_catalog_price">
                            ...
                            <div v-if="settings.paddle_transaction_type == 'catalog'" class="mb-4">
                                ...
                                <el-row v-for="(item, index) in settings.paddle_catalog_data" :key="index" :gutter="20"
                                        class="mb-4">
                                    <el-col :span="10">
                                        <el-form-item class="ff-form-item">
                                            <template #label>
                                    ...
                                    <el-col :span="10">
                                        <el-form-item class="ff-form-item">
                                            ...
                                            <el-select class="w-100" v-model="item.quantity" clearable filterable
                                                       :placeholder="$t('Select quantity field')">
                                                <el-option
                                    ...
                                    <el-col class="mt-6" :span="4">
                                        <action-btn>
                                            ...
                                            <action-btn-remove v-if="settings.paddle_catalog_data.length > 1"
                                                               @click="removeItem(index, 'paddle_catalog_data')"></action-btn-remove>
                                        </action-btn>
                                    </el-col>
                                </el-row>
                            </div>
                            ...
                            <div v-if="settings.paddle_transaction_type == 'non_catalog_price'" class="mb-4">
                                ...
                                <el-row v-for="(item, index) in settings.paddle_non_catalog_price_data" :key="index"
                                    ...
                                    <el-col :span="10">
                                        <el-form-item class="ff-form-item">
                                            ...
                                            <el-select class="w-100" v-model="item.product_id" clearable filterable
                                    ...
                                    <el-col :span="10">
                                        <el-form-item class="ff-form-item">
                                            ...
                                            <el-select class="w-100" v-model="item.payment_item" clearable filterable
                                                       :placeholder="$t('Select a payment item')" :valueKey="'name'">
                                                <el-option
                                    ...
                                    <el-col class="mt-6" :span="4">
                                        <action-btn>
                                            <action-btn-add
                                                @click="addItemAfter(index, 'paddle_non_catalog_price_data')"></action-btn-add>
                                            <action-btn-remove v-if="settings.paddle_non_catalog_price_data.length > 1"
                                                               @click="removeItem(index, 'paddle_non_catalog_price_data')"></action-btn-remove>
                                        </action-btn>
                                    </el-col>
                                </el-row>
                            </div>
