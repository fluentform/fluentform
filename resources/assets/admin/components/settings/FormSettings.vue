              ...
              <card  id="front_end_view" v-if="front_end_entry_view">
                ...
                <card id="advanced-form-validation">
                    <card-head>
                        <card-head-group class="justify-between">
                            ...
                            <video-doc btn_size="medium" :btn_text="$t('Learn More')" route_id="advancedValidation"/>
                        </card-head-group>
                        <p
                            class="text"
                            v-html="
                    ...
                    <card-body>
                        ...
                        <update-to-pro-content v-else :update-message="$t('Advanced Form Validation is available in the pro version')" utm-content="feature_lock_advanced_validation" />
                    </card-body>
                </card>
                ...
                <card id="survey-result">
                    <card-head>
                        <card-head-group class="justify-between">
                            ...
                            <video-doc btn_size="medium" :btn_text="$t('Learn More')" route_id="quizAndSurvey"/>
                        </card-head-group>
                    </card-head>
                    <card-body>
                        <survey-result v-if="hasPro" :data="formSettings.appendSurveyResult" :hasPro="hasPro"/>
                        <update-to-pro-content v-else :update-message="$t('Survey Result is available in the pro version')" utm-content="feature_lock_survey_result" />
                    </card-body>
                </card>
                ...
                <card id="compliance-settings">
                    ...
                    <card-body>
                        ...
                        <update-to-pro-content  v-if="!hasPro" :update-message="$t('Compliance Settings is available in the pro version')" utm-content="feature_lock_compliance_settings" />
                    </card-body>
                </card>
                ...
                <card id="other">
                    ...
                    <card-body class="el-form--label-top">
                        ...
                        <update-to-pro-content v-else :update-message="$t('Extra CSS Form Class is available in the pro version')" utm-content="feature_lock_extra_css_class" />
                    </card-body>
                </card>
...
<!--                        </notice>-->
                ...
                <card v-if="is_conversion_form && hasConvFormSaveAndResume" id="conv_form_per_step_save">
                    ...
                    <card-body class="el-form--label-top">
                        ...
                        <update-to-pro-content v-else :update-message="$t('Conversational Form Per Step Save is available in the pro version')" utm-content="feature_lock_conversational_step_save" />
                    </card-body>
                </card>
