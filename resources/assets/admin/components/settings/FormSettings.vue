                        ...
                        <el-form class="mt-4" v-if="double_optin.status == 'yes'" :data="double_optin"
                            ...
                            <template v-if="double_optin.email_field">
                                <el-form-item class="ff-form-item">
                                    ...
                                    <p class="mt-1 fs-14">
                                        {{ $t("This message will be shown after the intial form submission") }}
                                    </p>
                                </el-form-item>
                                ...
                                <div v-if="hasFluentCRM" class="form_item">
                                    <el-checkbox true-value="yes" false-value="no"
                                        ...
                                        {{ $t("Disable Double Optin if contact email is subscribed in ")
                                        }}<b>FluentCRM</b>
                                    </el-checkbox>
                                </div>
                            </template>
                ...
                <card id="front_end_view" v-if="front_end_entry_view">
                    ...
                    <card-body>
                        ...
                        <el-form label-position="top">
                            <el-row :gutter="24">
                                <el-col>
                                    <el-checkbox true-label="yes" false-value="no"
                                                 v-model="front_end_entry_view.status">
...
export default {
    name: "FormSettings",
    inject: ["eventBus"],
    emits: ["refetch-all-editor-shortcodes"],
    props: {
        "form": Object,
