                        ...
                        <btn-group>
                            <btn-group-item>
                                <video-doc btn_size="default" :btn_text="$t('Learn More')"
                                           route_id="otherConfirmationSettings"/>
                            </btn-group-item>
                            <btn-group-item>
                                <el-button
                                    class="el-button--soft"
                                    v-if="selected" type="info"
                                    size="default"
                                    @click="discard"
                                >
                                    <template #icon>
                    ...
                    <template v-if="has_pro">
                            ...
                            <el-skeleton :loading="confLoading" animated :rows="6">
                                <el-table :data="confirmations">
                                    ...
                                    <el-table-column prop="name" :label="$t('Name')" width="180"
                                                     class-name="content-ellipsis"></el-table-column>
                        ...
                        <template v-if="selected">
                            ...
                            <el-form-item class="ff-form-item">
                                ...
                                <FilterFields :fields="inputs" :conditionals="selected.conditionals"
                                              :hasPro="has_pro"></FilterFields>
                            </el-form-item>
                        </template>
                    </template>
