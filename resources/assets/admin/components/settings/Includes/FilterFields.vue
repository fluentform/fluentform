    ...
    <div class="ff-filter-fields-wrap">
        ...
        <div v-if="conditionals.status" class="mt-3">
            <div class="mb-3">
                ...
                <el-select
                    class="ff-select ff-select-small ml-1 mr-1"
                ...
                <div v-for="(group, groupIndex) in items" :key="groupIndex">
                    <template>
                        <div class="group-container">
                            <el-row class="group-header items-center">
                                <el-col :md="12" class="mb-1">
                                    <div class="title-section">
                                        ...
                                        <el-tooltip class="item"
                                                    :content="$t('Enter a descriptive name for this condition group if you want. This helps you identify different sets of rules easily.')"
                                                    placement="bottom" popper-class="ff_tooltip_wrap">
                                ...
                                <el-col :md="12" class=" mb-0">
                                    <div class="actions pull-right">
                                        ...
                                        <el-button class="el-button--icon" size="mini" v-if="items.length > 1"
                                                   @click="removeGroup(groupIndex)" icon="el-icon-delete" type="danger">
                                        </el-button>
                                        <el-button class="el-button--icon" size="mini" @click="toggleGroup(group)"
                                                   plain>
                                            <i :class="[
                            ...
                            <el-row v-for="(logic, ruleIndex) in group.rules" :key="`${groupIndex}-${ruleIndex}`"
                                    :gutter="5" class="items-center conditional-logic" v-show="group.isGroupOpen">
                                        ...
                                        <el-select size="small"
                                            ...
                                            <el-option-group :label="$t('General Operators')">
                                                ...
                                                <template
                                                    ...
                                                    <el-option value=">="
                                                               :label="$t('greater than or equal')"></el-option>
                                                    <el-option value="<=" :label="('less than or equal')"></el-option>
                                                    <el-option value="contains" :label="$t('contains')"></el-option>
                                                    <el-option value="doNotContains"
                                                               :label="$t('do not contains')"></el-option>
                                                    <el-option value="startsWith"
                                                               :label="$t('starts with')"></el-option>
                                                    <el-option value="endsWith" :label="$t('ends with')"></el-option>
                                                </template>
                                            </el-option-group>
                                            <el-option-group :label="$t('Advanced Operators')">
                                                <el-option value="length_equal"
                                                           :label="$t('Equal to Data Length')"></el-option>
                                                <el-option value="length_less_than"
                                                           :label="$t('Less than to Data length')"></el-option>
                                ...
                                <el-col :md="8" class="mb-0">
                                    <div>
                                        <template
                                            v-if="logic.operator == 'length_equal' || logic.operator == 'length_less_than' || logic.operator == 'length_greater_than'">
                                            <el-input size="small"
                                                      type="number" step="1" :placeholder="('Enter length in number')"
                                                      v-model="logic.value" />
                                        </template>
                                        <template v-else>
                                            <el-select
                                ...
                                <el-col :md="2" class="mb-0 ">
                                    <action-btn class="pull-right">
                                        <action-btn-remove size="mini" v-if="group.rules.length > 1"
                        ...
                        <div v-if="items && groupIndex !== items.length - 1" class="ff_cond_or">
                            <span>{{ $t("OR") }}</span>
                        </div>
