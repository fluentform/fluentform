    ...
    <div class="ff-add-confirmation-wrap">
        ...
        <template v-if="confirmation.redirectTo === 'samePage'">
            ...
            <el-form-item class="ff-form-item">
                ...
                <wp-editor :height="150" :editor-shortcodes="emailBodyeditorShortcodes"
                           v-model="confirmation.messageToShow"/>
            </el-form-item>
            ...
            <el-form-item class="ff-form-item">
                ...
                <el-radio v-model="confirmation.samePageFormBehavior"
                          value="hide_form" border>{{ $t('Hide Form') }}
                </el-radio>

                <el-radio v-model="confirmation.samePageFormBehavior"
                          value="reset_form" border>{{ $t('Reset Form') }}
                </el-radio>
            </el-form-item>
        </template>
        ...
        >
            ...
            <el-select class="w-100" v-model="confirmation.customPage" filterable :placeholder="$t('Select Page')">
                <el-option
                    v-for="page in pages"
                    :key="page.ID"
        ...
        <template v-if="confirmation.redirectTo === 'customPage' || confirmation.redirectTo === 'customUrl'">
            <el-form-item :label="$t('Redirect Query String')" class="conditional-items ff-form-item">
                <el-checkbox v-model="confirmation.enable_query_string" true-value="yes" false-value="no">
