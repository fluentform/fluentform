            ...
            <card-head>
                <card-head-group class="justify-between">
                    ...
                    <btn-group>
                        ...
                        <btn-group-item>
                            <video-doc btn_size="default" :route_id="integration_name" :btn_text="$t('Learn More')" />
                        </btn-group-item>
                    </btn-group>
                </card-head-group>
            </card-head>
                    ...
                    <el-form v-if="!loading_app" label-position="top">
                        <template v-for="(field, fieldIndex) in settings_fields.fields">
                            ...
                            >
                                ...
                                <div class="ff_chained_ajax_field"
                                     v-else-if="field.component === 'chained-ajax-fields'">
...
import PostMetaPluginMapping from "@/admin/components/settings/_PostMetaPluginsMapping.vue";
