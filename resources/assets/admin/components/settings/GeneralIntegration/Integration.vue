                ...
                <card-head-group class="justify-between">
                    ...
                    <div v-if="!isEmpty(available_integrations)" class="action-buttons">
                        <el-dropdown @command="add" :hide-on-click="false" trigger="click">
                            ...
                            <template #dropdown>
                                <el-dropdown-menu class="ff-dropdown-menu" style="max-height: 400px; overflow: auto">
                                <el-dropdown-item>
                                    <el-input size="large" @click.prevent autofocus v-model="search"
                                              :placeholder="$t('Search Integration')"></el-input>
                                </el-dropdown-item>
            ...
            <card-body>
                        ...
                        <el-table v-if="!isEmpty(available_integrations)" :data="integrations">
                            <template #empty>
                                <div class="getting_started_message" style="padding-top: 16px; padding-bottom: 10px;">
                                    <p>{{
                                            $t('You haven\'t added any integration feed yet. Add new integration to connect your favourite tools with your forms')
                                        }}</p>
                                </div>
                            </template>
                ...
                <p v-if="has_pro && !integrations.length" class="text-center">
                    ...
                    <a style="margin-left: 20px" target="_blank" rel="noopener"
                       href="https://wpmanageninja.com/docs/fluent-form/integrations-available-in-wp-fluent-form/">
