<template>
    <div v-loading="loading" class="ff_chained_filter">
        <el-select :class="select_class" @change="handleCategoryChange()" clearable v-model="chained_settings.category"
                   :placeholder="field.category_label">
            <el-option
        ...
        <el-select :class="select_class" v-show="chained_settings.category" v-model="chained_settings.sub_category"
                   clearable :placeholder="field.subcategory_label">
            <el-option
