<template>
    <el-form v-if="editing_item" label-position="top">
        ...
        <el-form-item class="ff-form-item" required>
            <template #label>
                ...
                <el-tooltip class="item" placement="bottom-start" popper-class="ff_tooltip_wrap">
                    <template #content>
                        <p>
                            {{
                                $t('Select if all fields or select fields should be sent with the webhook request.')
                            }}
                        </p>
                    </template>
                    <i class="ff-icon ff-icon-info-filled text-primary"></i>
            ...
            <el-radio v-model="editing_item.request_body" value="selected_fields">{{
                    $t('Selected Fields')
                }}
            </el-radio>
                    ...
                    <td>
                        <div>
                            ...
                            <action-btn class="ml-2 mb-1">
                                ...
                                <action-btn-remove v-if="editing_item.fields.length > 1"
                                                   @click="removeFieldRow(mappedKey)"></action-btn-remove>
                            </action-btn>
                        </div>
                    </td>
                </tr>
