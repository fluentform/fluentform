        ...
        <card id="integration-failure-notification">
            ...
            <card-body>
                <el-form-item class="ff-form-item">
                    ...
                    <update-to-pro-content v-else :update-message="$t('Integration Failure Email Notification is available in the pro version')" utm-content="feature_lock_failure_notification" />
                </el-form-item>
        ...
        <card id="miscellaneous">
            ...
            <card-body>
                ...
                <el-form-item class="ff-form-item">
                    ...
                    <update-to-pro-content :update-message="$t('Geo-Location provider is available in the pro version')" utm-content="feature_lock_geo_location" v-else/>
                </el-form-item>
                ...
                <el-form-item class="ff-form-item">
                    ...
                    <update-to-pro-content :update-message="$t('File Upload Field & Location is available in the pro version')" utm-content="feature_lock_file_upload_location" v-else/>
                ...
                <el-form-item class="ff-form-item">
                    ...
                    <update-to-pro-content v-if="!hasPro" :update-message="$t('Pretty URL Base Slug is available in the pro version')" utm-content="feature_lock_pretty_url_slug" />
                </el-form-item>
