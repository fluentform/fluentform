        ...
        <card id="miscellaneous">
            ...
            <card-body>
                <el-form-item class="ff-form-item-flex ff-form-item">
                    ...
                    <el-switch class="el-switch-lg" active-color="#00b27f" v-model="misc.isIpLogingDisabled"></el-switch>
                </el-form-item>
                ...
                <el-form-item class="ff-form-item-flex ff-form-item">
                    ...
                    <el-switch class="el-switch-lg" active-color="#00b27f" v-model="misc.isAnalyticsDisabled"></el-switch>
                </el-form-item>
                ...
                <el-form-item class="ff-form-item-flex ff-form-item">
                    ...
                    <el-switch class="el-switch-lg" active-color="#00b27f" active-value="yes" inactive-value="no"
                ...
                <div class="el-form-item-wrap">
                    <el-form-item class="ff-form-item-flex ff-form-item mb-3">
                        ...
                        <el-switch class="el-switch-lg" :disabled="!hasCaptcha" active-color="#00b27f"
