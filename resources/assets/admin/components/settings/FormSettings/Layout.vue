                ...
                <template v-if="email_report.status === 'yes'">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="24" v-if="email_report.send_to_type === 'custom_email'">
                            <el-form-item class="ff-form-item">
                                <label class="mb-3" style="display: block;">{{
                                        $t('Enter Recipient Email Address')
                                    }}</label>
                                <el-input class="w-100" :placeholder="$t('Recipient Email Address')"
                                          v-model="email_report.custom_recipients"></el-input>
                                <p class="fs-14 mt-1">{{
                                        $t('For multiple email addresses, use comma to separate them.')
                                    }}</p>
                            </el-form-item>
                        </el-col>
                        <el-col :sm="24" :md="12">
        ...
        <card id="default-messages">
            <card-head>
                ...
                <p class="text">
                    ...
                    {{ $t("Use") }}
                    <code>{labels.current_field}</code>{{ $t("shortcode for automatically resolve the field label.") }}
                </p>
            </card-head>
            <card-body>
            ...
            <card-body>
                ...
                <template v-if="akismet_available">
                    ...
                    <el-form-item v-if="misc.akismet_status === 'yes'">
                        ...
                        <el-radio-group v-model="misc.akismet_validation">
                            ...
                            <el-radio value="validation_failed">{{
                                    $t('Make the Form Submission as Failed')
                                }}
                            </el-radio>
                        </el-radio-group>
                        ...
                        <el-col :span="24">
                            <p v-if="misc.geo_provider && geo_providers[misc.geo_provider].token_instruction"
                               class="text-note" style="margin-top: -14px;">
                                {{ geo_providers[misc.geo_provider].token_instruction }}</p>
                        </el-col>
                    </el-row>
                    <notice class="ff_alert_between" type="danger-soft" v-else>
                        <div>
                ...
                <div class="el-form-item-wrap">
                    ...
                    <el-radio-group v-model="misc.captcha_type" v-if="misc.autoload_captcha">
                        <el-radio :disabled="!captcha_status.recaptcha" value="recaptcha">{{
                                $t('Google ReCaptcha')
                            }}
                        </el-radio>
                        <el-radio :disabled="!captcha_status.hcaptcha" value="hcaptcha">{{ $t('hCaptcha') }}</el-radio>
                        <el-radio :disabled="!captcha_status.turnstile" value="turnstile">{{
                                $t('Turnstile')
                            }}
                        </el-radio>
                    </el-radio-group>
