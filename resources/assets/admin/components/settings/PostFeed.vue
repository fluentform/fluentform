                ...
                <div class="post_feed">
                    <el-form label-position="top">
                        ...
                        <el-form-item class="ff-form-item" :label="$t('Post Type')">
                            <el-input class="ff_input_full_width" disabled
                        ...
                        <el-form-item class="ff-form-item">
                            ...
                            <el-checkbox v-model="feed.value.allowed_guest_user">
                                {{ feed.value.allowed_guest_user ? "Allowed" : "Not Allowed" }}
                            </el-checkbox>
                        </el-form-item>
                        ...
                        <el-row :gutter="24">
                            ...
                            <el-col :lg="6" style="flex: 1">
                                <el-form-item class="ff-form-item"
                                              v-if="post_settings.post_info.value.post_type == 'post'"
                                              :label="('Default Category')">
                                    <el-select clearable v-model="feed.value.default_category"
                                               class="ff_input_full_width">
                                        <el-option
