                    ...
                    <card-head-group class="justify-between">
                        <div>
                            ...
                            <p class="text" v-if="settings.status !== 'yes'">
                                {{ (" Publish forms on a dedicated landing page for more conversion.") }}</p>
                        </div>
                    ...
                    <div v-if="settings.status === 'yes'" class="ff_landing">
                        <div class="ff_landing_sidebar">
                            <div class="ffc_sidebar_header">
                                <tab>
                                    <tab-item :class="{active : active_tab === 'design'}"
                                              @click="active_tab = 'design'">
                                        <tab-link>
                                            {{ $t("Design") }}
                                        </tab-link>
                                    </tab-item>
                            ...
                            <div v-if="settings && active_tab === 'design'"
                                 class="ff_landing_settings_wrapper ffc_sidebar_body">
                                <el-form ref="form" :model="settings" label-position="top">
                                    <el-form-item class="ff-form-item">
                                        <el-radio-group v-model="settings.design_style">
                                            <el-radio v-for="(layoutName, layoutCode) in layouts" :key="layoutCode"
                                                      :value="layoutCode">{{ layoutName }}
                                            </el-radio>
                                        </el-radio-group>
                                    </el-form-item>
                                    ...
                                    <el-form-item class="ff-form-item">
                                        ...
                                        <el-color-picker
                                            @active-change="(color) => { settings.custom_color = color; }"
                                            v-model="settings.custom_color"
                                        />
                                    </el-form-item>

                                    <template v-for="(item, i) in settings.form_shadow" :key="i">
                                    ...
                                    <el-form-item class="ff-form-item">
                                        ...
                                        <photo-uploader enable_clear="yes" design_mode="horizontal"
                                                        v-model="settings.background_image" />
                                    </el-form-item>
                                    ...
                                    <el-form-item class="ff-form-item">
                                        ...
                                        <photo-uploader enable_clear="yes" design_mode="horizontal"
                                                        v-model="settings.featured_image" />
                                    </el-form-item>
                                ...
                                <el-form ref="form" :model="settings" label-position="top">
                                    <div class="ff_landing_page_items">
                                        ...
                                        <el-form-item class="ff-form-item">
                                            ...
                                            <el-input :placeholder="$t('eg: My Awesome Form')"
                            ...
                            <div class="ff_landing_settings_wrapper ffc_sidebar_body"
                        ...
                        <div class="ff_landing_preview ffc_design_container">
                            <template v-if="active_tab === 'design'">
                                <browser :settings="settings" v-if="final_share_url && show_frame"
                                         :preview_url="final_share_url" @change-device-type="changeDeviceType" />
                            </template>
...
import ConversionStylePref from "@/admin/conversion_templates/ConversionStylePref.vue";
import Browser from "./_Browser.vue";
import Share from "./_Sharing.vue";
import Ff_boxshadow from "./BoxShadow.vue";
