...
<iframe id="fluentform" width="100%" height="500px" style="min-height: 500px;with: 100%" frameborder="0" src="{{share_url}}&embedded=1" onload="this.style.height=(this.contentWindow.document.body.scrollHeight+40)+'px';"></iframe></textarea>
