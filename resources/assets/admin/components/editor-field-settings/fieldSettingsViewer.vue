...
export default {
    ...
    computed: {
        generalEditOptions() {
            const attachExtras = composeFieldOptions(this.editItemElement[this.editItem.element].general);
        ...
        advancedEditOptions() {
            const attachExtras = composeFieldOptions(this.editItemElement[this.editItem.element].advanced);
