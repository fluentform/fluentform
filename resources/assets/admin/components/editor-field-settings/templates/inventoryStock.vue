<template>
    <div>
        <el-form-item v-if="isInventoryEnabled">
            ...
            <div v-if="optionsToRender.length" class="ff_advanced_options_wrap">
                <div
                    class="vddl-list__handle optionsToRender"
                    v-for="(option, index) in editItem.settings[getOptionsKey]"
                    :key="option.id"
                >
                    <div class="">
                        ...
                        <template v-if="!isSingleInput">
                            <el-row :gutter="10" style="align-items: center">
                                <el-col :span="12">
                                    <!-- Global Inventory -->
                                    <el-select
                                        v-if="isGlobalInventory"
                                        class="el-fluid"
                                        v-model="editItem.settings[getOptionsKey][index].global_inventory"
                                        :filterable="true"
                                        clearable
                                    >
                                        <el-option
                                    ...
                                    <el-input
                                        ...
                                        :min="1"
                                        type="number"
                                        v-model.number="editItem.settings[getOptionsKey][index].quantity"
                                    ></el-input>
                                </el-col>
                                <el-col :span="12">
                                    <span>
                        ...
                        <template v-else>
                            ...
                            <el-select
                                v-if="isGlobalInventory"
                                class="el-fluid"
                                v-model="editItem.settings.global_inventory"
                                :filterable="true"
                                clearable
                            >
                                <el-option
