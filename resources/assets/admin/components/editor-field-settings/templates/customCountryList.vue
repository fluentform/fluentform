...
<div>
    <el-form-item label="Default Country">
        <el-select id="settings.country_list" v-model="editItem.attributes.value" placeholder="None" class="el-fluid">
    ...
    <template v-if="settings.country_list.active_list == 'priority_based'">
