    ...
    <div>
        <el-form-item label="Default Country">
            <el-select 
                ...
                class="el-fluid"
            >
                <el-option value="" :selected="!editItem.attributes.value" :label="$t('None')"></el-option>
            ...
            <el-select 
                ...
                class="el-fluid"
            >
                <el-option value="" :selected="!editItem.settings.default_country" :label="$t('None')"></el-option>
                <el-option v-for="(name, key) in countries" :value="key" :label="name" :key="key"></el-option>
            </el-select>
        </el-form-item>

        <el-form-item label="Country List">
            <el-radio-group class="ff_radio_group" size="mini" v-model="settings[listItem.key].active_list">
