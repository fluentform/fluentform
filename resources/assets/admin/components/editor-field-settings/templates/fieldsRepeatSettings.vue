    ...
    <div class="el-form-item ff-repeater-setting">
        ...
        <div class="address-field-option" v-for="(field, i) in editItem.fields" :key="i">
            ...
            <div class="address-field-option__settings">
                    ...
                    <div class="el-form-item">
                        ...
                        <div class="el-form-item__content">
                            <el-select class="w-100" @change="changeFieldType(field, i)" v-model="field.element">
                                <el-option
                                    v-for="(element, elementName) in available_elements"
                                    :key="elementName"
                                    :value="elementName"
                                    :label="$t(element)"
                                ></el-option>
                ...
                <div
                    v-if="
                        field.element === 'input_text' ||
                        field.element === 'input_email' ||
                        field.element === 'input_number'
                    "
                >
                ...
                settings: {
                    ...
                    validation_rules: {
                        required: {
                            ...
                            global: true,
                            global_message:
                                this.editItem.fields[0]?.settings?.validation_rules?.required?.global_message || '',
