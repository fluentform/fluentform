            ...
            <el-form-item>
                <input-yes-no-checkbox
                    ...
                    :listItem="{
                        ...
                        help_text:
                            $t(`Toggle to display only unique results based on the `) + listItem.sources[model.source]
                    }"
                ></input-yes-no-checkbox>
            </el-form-item>
                ...
                <el-row :gutter="20" type="flex" align="middle">
                    <el-col :span="8">
                        <el-button
                            ...
                            type="primary"
                            size="small"
                            :icon="result_loading ? 'el-icon-loading' : 'el-icon-refresh'"
                            >{{ $t('Get Result') }}
                        </el-button>
                    </el-col>
                    <el-col :span="16">
                        <p>
                            <span>
                                <el-link @click="validOptionsDialog = true" type="primary"
                                    >{{ result_counts.valid || 0 }}
                                </el-link>
                                {{ $t('valid option of ') }}
                            </span>
                            <span>
                                <el-link @click="allOptionsDialog = true" type="primary"
            ...
            <el-form-item v-if="hasTemplateColumnsOptions">
                <template #label>
                    <elLabel
                        ...
                        :help-text="
                            $t(
                                'Define the mapping template for generate options. Use placeholders to dynamically insert values from the database records.'
                            )
                        "
                    >
                    </elLabel>
...
export default {
    ...
    methods: {
        isValid() {
            return !(this.isDynamicCsv && !this.model.csv_url);
        },
