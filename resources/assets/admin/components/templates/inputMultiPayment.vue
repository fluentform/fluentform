    ...
    <withLabel :item="item">
        ...
        <template v-else-if="inputType === 'select'">
            <select class="select el-input__inner">
                <option v-for="(option, index) in item.settings.pricing_options" :key="index">
                    {{ option.label }}
                </option>
            </select>
        </template>
        <template v-else-if="!item.settings.enable_image_input">
            <el-radio-group v-if="inputType === 'radio'" class="el-radio-horizontal">
                <el-radio v-for="option in item.settings.pricing_options" :value="option.value" :key="option.value">
                    {{ option.label }}
                </el-radio>
            </el-radio-group>
            <template v-else>
