...
<script>
    ...
    export default {
        ...
        computed: {
	        ...
	        campaignUrl() {
				const element = 'string' === typeof this.visibility ? this.visibility : '';
				const feature = element || (this.modal?.is_payment ? 'payment_field' : 'form_field');
				return upgradeUrl('feature_lock_' + feature);
            },
