    ...
    methods: {
        ...
        generateCss(settings) {
            ...
            if (settings.answer_color) {
                ...
                css += `${prefix} .f-answer .f-star-wrap .f-star-field-wrap .ff-rating-icon-svg { color: ${this.hexToRGBA(settings.answer_color, '0.25')}; display: block; height: auto; max-height: 64px; max-width: 64px; width: 100%; }`;
                ...
                css += `${prefix} .f-answer .f-star-wrap .f-star-field-wrap.is-hovered .ff-rating-icon-svg { color: ${this.hexToRGBA(settings.answer_color, '0.4')}; }`;
                css += `${prefix} .f-answer .f-star-wrap .f-star-field-wrap.is-selected .ff-rating-icon-svg { color: ${settings.answer_color}; }`;
