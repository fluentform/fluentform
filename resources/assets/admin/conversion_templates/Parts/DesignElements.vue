    ...
    <div class="ffc_design_elements">
        <el-form label-position="left" :data="design_settings">
            ...
            <div v-if="!has_pro" class="fcc_pro_message">
                ...
                <a target="_blank" rel="noopener" :href="upgradeUrl('feature_lock_conversational_design', 'https://fluentforms.com/conversational-form')" class="el-button el-button--success el-button--small">{{
