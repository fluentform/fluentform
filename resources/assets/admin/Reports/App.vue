            ...
            <el-tabs v-model="activeTab" class="reports-main-tabs">
                <el-tab-pane :label="$t('Overview')" name="overview">
                    ...
                    <div class="reports-header">
                        <div>
                            <h1 class="reports-title">{{ $t('Overview') }}</h1>
                        ...
                        <div class="reports-controls">
                            <a
                                ...
                                target="_blank"
                                class="el-button el-button--medium pdf-download-btn"
                            >
	                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		                            <path d="M10.75 8.5H14.5L10 13L5.5 8.5H9.25V3.25H10.75V8.5ZM4 15.25H16V10H17.5V16C17.5 16.1989 17.421 16.3897 17.2803 16.5303C17.1397 16.671 16.9489 16.75 16.75 16.75H3.25C3.05109 16.75 2.86032 16.671 2.71967 16.5303C2.57902 16.3897 2.5 16.1989 2.5 16V10H4V15.25Z" fill="#0E121B"/>
	                            </svg>
                ...
                <el-tab-pane :label="$t('Payments')" name="revenue" v-if="hasPayment">
                    ...
                    <div class="reports-header">
                        <div>
                            ...
                            <p class="reports-description">{{ $t('A brief look at all payments') }}</p>
                        </div>
                        <div class="reports-controls">
                            <el-select
                                v-model="selectedGlobalFormId"
                ...
                <el-tab-pane :label="$t('Submission')" name="submission">
                    ...
                    <div class="reports-header">
                        <div>
                            <h1 class="reports-title">{{ $t('Submission') }}</h1>
                            <p class="reports-description">{{ $t('A brief look at submission performance') }}</p>
                        </div>
                        <div class="reports-controls">
                            <el-select
                                v-model="selectedGlobalFormId"
        ...
        formOverviewStatsCards() {
            ...
            let cards = [
                ...
                },
                {
                    ...
                    icon: `<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.45 3.44922L22.4 11.9992L17.45 20.5492H7.54998L2.59998 11.9992L7.54998 3.44922H17.45ZM16.4123 5.24922H8.58768L4.67988 11.9992L8.58768 18.7492H16.4123L20.3201 11.9992L16.4123 5.24922ZM11.6 14.6992H13.4V16.4992H11.6V14.6992ZM11.6 7.49922H13.4V12.8992H11.6V7.49922Z" fill="#525866"/></svg>`,
                },
                {
                    key: "unread_submissions",
                    title: this.$t('Unread Submissions'),
