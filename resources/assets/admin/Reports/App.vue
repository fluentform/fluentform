        ...
        <el-row :gutter="24" class="charts-row">
            ...
            <el-col :span="8">
                <completion-rates-gauge
                    ...
                    @form-change="handleGaugeFormChange"
                />
            </el-col>
        </el-row>
        ...
        <el-row :gutter="24" style="margin-bottom: 24px;">
            ...
            <el-col :span="10" v-if="hasPayment">
                <subscription-stats
                    ...
                    :key="JSON.stringify(reports.subscriptions)"
                />
            </el-col>
        </el-row>
    ...
    methods: {
        fetchReports() {
            ...
            let data = {
                ...
                heatmap_start_date: this.globalDateParams.startDate,
                heatmap_end_date: this.globalDateParams.endDate,
                api_logs_start_date: this.globalDateParams.startDate,
                api_logs_end_date: this.globalDateParams.endDate,
                transactions_start_date: this.globalDateParams.startDate,
                transactions_end_date: this.globalDateParams.endDate,
        ...
        handleFormChange(formId) {
            this.globalDateParams.formId = formId;
            this.fetchReports();
        },
