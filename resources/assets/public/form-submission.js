...
jQuery(document).ready(function () {
            ...
            return (function (validator) {
                            ...
                            if ('redirectUrl' in res.data.result) {
                                if (res.data.result.message) {
                                    $('<div/>', {
                                        ...
                                        .html(sanitizeHtml(res.data.result.message))
                                        .insertAfter($theForm)
                                        .focus()
                                        ;
                ...
                var showErrorBelowElement = function (element, message) {
                    ...
                    if (el.closest('.ff-el-input--content').length) {
                        ...
                        el.closest('.ff-el-input--content').append(div.html(sanitizeHtml(message)));
                    } else {
                ...
                var initTriggers = function () {
                    ...
                    $theForm.find('.ff-el-tooltip').on('mouseenter', function (event) {
                        ...
                        $popContent.html(sanitizeHtml(content));
    ...
    jQuery('.fluentform').on('submit', '.ff-form-loading', function (e) {
        ...
        jQuery('<div/>', {
            ...
            .html(sanitizeHtml(window.fluentform_submission_messages_global?.javascript_handler_failed || 'Javascript handler could not be loaded. Form submission has been failed. Reload the page and try again'))
